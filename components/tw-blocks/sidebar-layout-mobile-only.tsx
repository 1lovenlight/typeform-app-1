...
export default function SidebarMobileOnlyLayout({
  children,
}: {
  children: ReactNode;
}) {
  ...
  return (
    <div className="h-full w-full flex flex-col">
      ...
      {/* Mobile Header */}
      <div className="sticky top-0 z-40 flex items-center justify-between gap-x-6 px-4 py-4 h-16">
      ...
      {/* Main content */}
      <main className="flex-1 w-full overflow-auto h-full">
